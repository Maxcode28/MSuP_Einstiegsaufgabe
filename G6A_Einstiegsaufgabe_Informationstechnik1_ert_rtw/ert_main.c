...
void rt_OneStep(void)
{
   ...
   */
  G6A_Einstiegsaufgabe_Informationstechnik1_SetEventsForThisBaseStep(eventFlags);
  enableTimer0Interrupt();
  G6A_Einstiegsaufgabe_Informationstechnik1_step0();
  ...
  if (need2runFlags[1]) {
    ...
    {
     case 1 :
      G6A_Einstiegsaufgabe_Informationstechnik1_step1();
...
int main(void)
{
  ...
  G6A_Einstiegsaufgabe_Informationstechnik1_initialize();
  ...
  /* Terminate model */
  G6A_Einstiegsaufgabe_Informationstechnik1_terminate();
