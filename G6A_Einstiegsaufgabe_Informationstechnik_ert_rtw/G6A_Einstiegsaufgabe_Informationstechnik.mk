...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/G6A_Einstiegsaufgabe_Informationstechnik.out
...
PRODUCT_NAME              = G6A_Einstiegsaufgabe_Informationstechnik
MAKEFILE                  = G6A_Einstiegsaufgabe_Informationstechnik.mk
COMPUTER                  = PCWIN64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/G6A_Einstiegsaufgabe_Informationstechnik.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/G6A_Einstiegsaufgabe_Informationstechnik_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/tic2000/inc -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/tic2000/src -I$(MATLAB_ROOT)/toolbox/rtw/targets/common/can/blocks/tlc_c -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/shared/EXTERN~1/include
...
%.obj : $(START_DIR)/G6A_Einstiegsaufgabe_Informationstechnik_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/G6A_Einstiegsaufgabe_Informationstechnik_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/G6A_Einstiegsaufgabe_Informationstechnik_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/G6A_Einstiegsaufgabe_Informationstechnik_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file=$@ $<
