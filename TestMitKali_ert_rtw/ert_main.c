...
void rt_OneStep(void)
{
   ...
   */
  TestMitKali_SetEventsForThisBaseStep(eventFlags);
...
int main(void)
{
  ...
  ;
  rtmSetErrorStatus(TestMitKali_M, 0);
  TestMitKali_initialize();
  configureTimer0(modelBaseRate, systemClock);
  runModel =
    rtmGetErrorStatus(TestMitKali_M) == (NULL);
  enableTimer0Interrupt();
